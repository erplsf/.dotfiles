...

{
  nix = {
    ...
    '';
    registry.nixpkgs.flake = inputs.nixpkgs; # pin to what we used to build the system
   };
  ...
  boot.initrd.luks.devices.root = {
    device = "/dev/disk/by-uuid/b91375ec-e3c9-4212-a928-29d9a22ff0d4";
    preLVM = true;
  };

  networking.hostName = "qemu-vm"; # Define your hostname.
